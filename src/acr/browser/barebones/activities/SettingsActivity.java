...
public class SettingsActivity extends Activity {
	...
	public void init() {
		...
		prisms = (TextView) findViewById(R.id.prismsText);

		boolean locationBool = settings.getBoolean("location", false);
		int flashNum = settings.getInt("enableflash", 0);
		boolean fullScreenBool = false; //settings.getBoolean("fullscreen", false);
	...
	public void agent(RelativeLayout view) {
		view.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				...
				CharSequence[] chars = { "http://www-sop.inria.fr/members/Luca.Costabello/foaf.rdf#me", "Desktop", "Mobile" };
				agentChoice = settings.getInt("agentchoose", 1);
				agentPicker.setSingleChoiceItems(chars, agentChoice - 1,
						new DialogInterface.OnClickListener() {
							...
							public void onClick(DialogInterface dialog,
								...
								switch (which + 1) {
								case 1:
									agentText.setText("http://inria.fr/Luca.Costabello/foaf.rdf#me");
									break;
								case 2:
									agentText.setText("Desktop");
									break;
